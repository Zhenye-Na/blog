...
% \par
% \textbf{Neural Network for Estimating Shortest Path Problem}\hfill 11/2017\\
% $\bullet$ Selected DNN and GCN as the model and implemented using Tensorflow.\\
% $\bullet$ Concluded an 84\% accuracy of prediction in Shortest Path problem.
...
% \item Introduced additional features like product information visualization, price notification, rigs payback period computation and recommendation system
% \end{rSubsection}
