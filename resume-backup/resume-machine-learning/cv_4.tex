...
\usepackage[left=0.25in,top=0.3in,right=0.25in,bottom=0.3in]{geometry} % Document margins
\usepackage{hyperref}
...
%------------------------------------------------
% \url{https://github.com/Zhenye-Na/self-driving-vehicles-sim-with-ml}
...
%------------------------------------------------
% \url{https://github.com/drl-dql/DQN-Flappy-Bird}
...
%------------------------------------------------
% \url{https://github.com/Zhenye-Na/image-similarity-using-deep-ranking}
...
Frameworks & Tensorflow, Pytorch, Keras, fast.ai, REST\\ % , Node.js, Django
