...
excerpt: "在浏览器输入 URL 回车之后发生了什么"
tags: [HTTP]
key: browser-http-what-happened
---
...
![img](https://github.com/Zhenye-Na/Zhenye-Na.github.io/blob/master/assets/images/posts-img/http-url-deep-dive/20190822181538-20190915004358457.png?raw=true){:.shadow.border.rounded}

## 二、DNS 查询

**基本步骤**

![img](https://github.com/Zhenye-Na/Zhenye-Na.github.io/blob/master/assets/images/posts-img/http-url-deep-dive/20190822181732-20190915004358287.png?raw=true){:.shadow.border.rounded}
...
![img](https://github.com/Zhenye-Na/Zhenye-Na.github.io/blob/master/assets/images/posts-img/http-url-deep-dive/1604181361-5a1397cca5644_articlex-20190915004357396.png?raw=true){:.shadow.border.rounded}

> 根域名服务器：[维基百科](https://zh.wikipedia.org/wiki/根網域名稱伺服器)
...
![img](https://github.com/Zhenye-Na/Zhenye-Na.github.io/blob/master/assets/images/posts-img/http-url-deep-dive/20190822182400-20190915004357859.png?raw=true){:.shadow.border.rounded}
...
![img](https://github.com/Zhenye-Na/Zhenye-Na.github.io/blob/master/assets/images/posts-img/http-url-deep-dive/20190822183251-20190915004357831.png?raw=true){:.shadow.border.rounded}
...
![img](https://github.com/Zhenye-Na/Zhenye-Na.github.io/blob/master/assets/images/posts-img/http-url-deep-dive/961f7b5d-9e06-4006-ab99-974e8e9e2ba5-20190915004359896.png?raw=true){:.shadow.border.rounded}
...
传输回来的其实都是一些二进制字节数据，浏览器需要根据文件指定编码（例如UTF-8）转换成字符串，也就是 HTML 代码。
...
![img](https://github.com/Zhenye-Na/Zhenye-Na.github.io/blob/master/assets/images/posts-img/http-url-deep-dive/1355879024-573db51949951_articlex-20190915004400416.png?raw=true){:.shadow.border.rounded}
...
![img](https://github.com/Zhenye-Na/Zhenye-Na.github.io/blob/master/assets/images/posts-img/http-url-deep-dive/20190822184523-20190915004358925.png?raw=true){:.shadow.border.rounded}
...
![img](https://github.com/Zhenye-Na/Zhenye-Na.github.io/blob/master/assets/images/posts-img/http-url-deep-dive/20190822184731-20190915004358898.png?raw=true){:.shadow.border.rounded}
...
![img](https://github.com/Zhenye-Na/Zhenye-Na.github.io/blob/master/assets/images/posts-img/http-url-deep-dive/20190822185002-20190915004400390.png?raw=true){:.shadow.border.rounded}
...
- [js引擎的执行过程（一）](https://heyingye.github.io/2018/03/19/js引擎的执行过程（一）/#预编译阶段)